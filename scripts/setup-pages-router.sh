...
echo "🧹 Removing App Router..."
rm -rf src/app

echo "📁 Creating Pages Router..."
mkdir -p src/pages
...
export default function Home() {
  return (
    <main className="min-h-screen p-6 md:p-12 lg:p-24 bg-white text-black">
...
echo "✅ Pages Router setup complete with full homepage."
